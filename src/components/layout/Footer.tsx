          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2">
              <Link to="/es" className="inline-flex flex-col items-center gap-1">
                <img src="/images/logo-mark.webp" alt="" className="h-14 w-14" loading="lazy" width={56} height={56} />
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/es/prepara-tu-viaje" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors">Prepara tu viaje</Link></li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/prepare-your-trip" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors">Prepare your trip</Link></li>
