...
import PrepareYourTrip from "./pages/PrepareYourTrip";
...
import EsPreparaTuViaje from "./pages/es/EsPreparaTuViaje";
import EsGraciasAsakusa from "./pages/es/EsGraciasAsakusa";
...
// 2026-07-20 batch: Mt Fuji Climbing Season (Tier 1 data-driven)
import MtFujiClimbingSeasonGuide from "./pages/blog/MtFujiClimbingSeasonGuide";
import EsTemporadaAscensoMonteFuji from "./pages/es/blog/EsTemporadaAscensoMonteFuji";
  ...
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      ...
      <Routes>
        ...
        <Route path="/prepare-your-trip" element={<PrepareYourTrip />} />
        ...
        <Route path="/es/prepara-tu-viaje" element={<EsPreparaTuViaje />} />
        <Route path="/es/gracias-asakusa" element={<EsGraciasAsakusa />} />
        ...
        {/* 2026-07-20 batch */}
        <Route path="/blog/mt-fuji-climbing-season-guide" element={<MtFujiClimbingSeasonGuide />} />
