    ...
    items: [
      {
        ...
        answer: "Our Tokyo walking tours range from ¥40,000 to ¥50,000 per group depending on the tour and duration. Day trips to Kamakura (¥70,000), Hakone (¥80,000), and Nikko (¥80,000) have different pricing. Check each tour page for specific rates, or contact us for a custom quote.",
      },
      {
