  ...
  return (
    <Layout>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-card border border-border rounded-lg p-6 space-y-6">
                ...
                <Link to="/es/contact" className="btn-accent w-full text-center" data-cta="book-now-tour-sidebar" onClick={() => trackBookNowClick("Reservar Esta Excursión", "tour-sidebar")}>
      ...
      <TourJsonLd
        ...
        area="Hakone"
      />
      <StickyBookingBar lang="es" tourSlug="hakone-day-trip" tourName="Excursión Privada a Hakone" price={siteDisplayPrice("hakone-day-trip", "es")} />
    </Layout>
  );
};
