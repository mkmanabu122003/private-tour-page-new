...
const extraFaqs: TourFaqItem[] = [
  {
    question: "¿Cuánto dura el tour a pie por Asakusa?",
    answer:
      "El tour dura aproximadamente 3 horas. Recorremos el Templo Senso-ji, la calle Nakamise, callejones escondidos y las vistas del río Sumida a un ritmo cómodo.",
  },
  {
    question: "¿El tour por Asakusa es adecuado para niños pequeños?",
    answer:
      "¡Sí! La ruta es plana y apta para carritos de bebé. A los niños les encanta el colorido templo, las fortunas (omikuji) y la comida callejera de Nakamise.",
  },
  {
    question: "¿Cuál es el mejor momento del día para el tour por Asakusa?",
    answer:
      "La mañana (inicio a las 10:00 AM) es ideal por haber menos multitudes y mejores fotos. La sesión de la tarde también funciona muy bien, especialmente para disfrutar de la iluminación nocturna del Senso-ji.",
  },
];

const EsAsakusa = () => {
  useEffect(() => { trackTourPageView("Tour Privado por Asakusa"); }, []);
  ...
  return (
    <Layout>
      ...
      {/* Value Comparison */}
      <ValueComparisonEs tourPrice={45000} tourName="Tour Privado por Asakusa" />
