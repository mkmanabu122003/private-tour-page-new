...
const EsYanaka = () => {
  useEffect(() => { trackTourPageView("Descubrimiento de Ueno y Yanaka"); }, []);
  ...
  return (
    <Layout>
      ...
      <TourJsonLd
        ...
        area="Yanaka"
      />
      <StickyBookingBar lang="es" tourSlug="yanaka" tourName="Descubrimiento de Ueno y Yanaka" price={siteDisplayPrice("yanaka", "es")} />
    </Layout>
  );
};
