  ...
  return (
    <Layout>
      ...
      <BlogArticleHero
        ...
        imageAlt="Izakaya japonés: qué comer en Japón"
      ...
      />
        ...
        <div className="container-section">
          ...
          { num: "01", label: "Cómo Usar Esta Guía", href: "#section-01-cómo-usar-esta-guía" },
          { num: "02", label: "Para el Desayuno", href: "#section-02-para-el-desayuno" },
          { num: "03", label: "Para el Almuerzo", href: "#section-03-para-el-almuerzo" },
          { num: "04", label: "Para la Cena", href: "#section-04-para-la-cena" },
          { num: "05", label: "Para Picar Entre Comidas", href: "#section-05-para-picar-entre-comidas" },
          { num: "06", label: "En Qué Orden Probar Todo", href: "#section-06-en-qué-orden-probar-todo" },
          { num: "07", label: "FAQ", href: "#section-07-faq" }
            ...
            {/* Cómo usar esta guía */}
            <div className="section-eyebrow"><span>Section 01 · Cómo Usar Esta Guía</span></div>
            <h2 id="section-01-cómo-usar-esta-guía" className="scroll-mt-20">
            ...
            {/* Desayuno */}
            <div className="section-eyebrow"><span>Section 02 · Para el Desayuno</span></div>
            <h2 id="section-02-para-el-desayuno" className="scroll-mt-20">
            ...
            {/* Almuerzo */}
            <div className="section-eyebrow"><span>Section 03 · Para el Almuerzo</span></div>
            <h2 id="section-03-para-el-almuerzo" className="scroll-mt-20">
            ...
            {/* Cena */}
            <div className="section-eyebrow"><span>Section 04 · Para la Cena</span></div>
            <h2 id="section-04-para-la-cena" className="scroll-mt-20">
            ...
            {/* Picar entre comidas */}
            <div className="section-eyebrow"><span>Section 05 · Para Picar Entre Comidas</span></div>
            <h2 id="section-05-para-picar-entre-comidas" className="scroll-mt-20">
            ...
            {/* Plan de 5 días */}
            <div className="section-eyebrow"><span>Section 06 · En Qué Orden Probar Todo</span></div>
            <h2 id="section-06-en-qué-orden-probar-todo" className="scroll-mt-20">
