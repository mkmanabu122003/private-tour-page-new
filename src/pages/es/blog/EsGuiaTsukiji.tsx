      ...
      <section className="py-16">
        <div className="container-section">
          <article className="max-w-3xl mx-auto prose-custom">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              La <strong className="text-foreground">observación de la subasta de atún</strong> es la razón principal para visitar. Tiene lugar en las primeras horas de la mañana, normalmente comenzando alrededor de las 5:30 AM, y los visitantes observan desde una plataforma de observación cerrada con cristal sobre el piso de la subasta. <strong className="text-foreground">Las reservas deben hacerse en línea con antelación</strong> a través del sitio web del Gobierno Metropolitano de Tokio, y las fechas populares se llenan con semanas de anticipación. Sin reserva, aún puedes visitar los corredores de observación del mercado para ver las operaciones mayoristas a través de paredes de cristal, pero no verás la subasta en sí.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
