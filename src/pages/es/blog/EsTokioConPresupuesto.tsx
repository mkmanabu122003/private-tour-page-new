  ...
  return (
    <Layout>
      ...
      <BlogArticleHero
        ...
        imageAlt="Calle comercial Nakamise en Asakusa, Tokio con presupuesto"
        eyebrow="Planifica Tu Viaje"
        title="Tokio con Presupuesto: Lo Que Gasta un Guía Local (Y Cómo)"
        subtitle="Escrito por Manabu, guía con licencia que vive en Tokio todo el año y sabe exactamente lo que cuestan las cosas, porque las paga todos los días."
      ...
      />
        ...
        <div className="container-section">
          ...
          { num: "01", label: "El Mito de Tokio Caro", href: "#section-01-el-mito-de-tokio-caro" },
          { num: "02", label: "Costes Diarios", href: "#section-02-costes-diarios" },
          { num: "03", label: "Dónde Comer por Menos de 1.000", href: "#section-03-dónde-comer-por-menos-de-1000" },
          { num: "04", label: "Experiencias Gratis vs. de…", href: "#section-04-experiencias-gratis-vs-de-pago" },
          { num: "05", label: "Dónde NO Recortar Gastos", href: "#section-05-dónde-no-recortar-gastos" },
          { num: "06", label: "FAQ", href: "#section-06-faq" }
            ...
            <div className="section-eyebrow"><span>Section 01 · El Mito de Tokio Caro</span></div>
            <h2 id="section-01-el-mito-de-tokio-caro" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 02 · Costes Diarios</span></div>
            <h2 id="section-02-costes-diarios" className="scroll-mt-20">
            ...
            <h3>Transporte: 1.000-1.500 por día</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <h3>Comida: 3.000-8.000 por día</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <h3>Atracciones y entradas: 500-2.000 por día</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div className="section-eyebrow"><span>Section 03 · Dónde Comer por Menos de 1.000</span></div>
            <h2 id="section-03-dónde-comer-por-menos-de-1000" className="scroll-mt-20">
            ...
            <h3>Tiendas de conveniencia (de verdad, son buenas)</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div className="section-eyebrow"><span>Section 04 · Experiencias Gratis vs. de Pago</span></div>
            <h2 id="section-04-experiencias-gratis-vs-de-pago" className="scroll-mt-20">
            ...
            {/* Dónde NO recortar */}
            <div className="section-eyebrow"><span>Section 05 · Dónde NO Recortar Gastos</span></div>
            <h2 id="section-05-dónde-no-recortar-gastos" className="scroll-mt-20">
            ...
            <h3>No te saltes una buena comida de sushi</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <h3>No elijas el alojamiento más barato en mala ubicación</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <h3>No te pierdas el contexto local: contrata un guía</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div className="mt-16">
              ...
              <div className="faq-block space-y-8">
                <div>
                  <h3>¿Cuánto dinero necesito por día en Tokio?</h3>
                ...
                <div>
                  <h3>¿Cuánto cuesta viajar a Tokio en total?</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3>¿Es más barato usar un pase de tren o comprar billetes individuales?</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3>¿Cuál es la zona más barata para alojarse en Tokio?</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3>¿Se puede hacer Tokio barato sin perder experiencias importantes?</h3>
                  <p className="text-muted-foreground leading-relaxed">
