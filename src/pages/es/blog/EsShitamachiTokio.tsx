  ...
  return (
    <Layout>
      ...
      <BlogArticleHero
        ...
        imageAlt="Calles tradicionales del shitamachi en Tokio"
      ...
      />
        ...
        <div className="container-section">
          ...
          { num: "01", label: "¿Qué es el shitamachi?", href: "#section-01-qué-es-el-shitamachi" },
          { num: "02", label: "Los barrios del shitamachi…", href: "#section-02-los-barrios-del-shitamachi-que-puedes-visitar-hoy" },
          { num: "03", label: "La vida en el shitamachi", href: "#section-03-la-vida-en-el-shitamachi" },
          { num: "04", label: "Cómo visitar el shitamachi…", href: "#section-04-cómo-visitar-el-shitamachi-sin-romper-su-magia" },
          { num: "05", label: "Mi ruta personal por el…", href: "#section-05-mi-ruta-personal-por-el-shitamachi-de-tokio" },
          { num: "06", label: "FAQ", href: "#section-06-faq" }
            ...
            <div className="section-eyebrow"><span>Section 01 · ¿Qué es el shitamachi?</span></div>
            <h2 id="section-01-qué-es-el-shitamachi" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 02 · Los barrios del shitamachi que puedes visitar hoy</span></div>
            <h2 id="section-02-los-barrios-del-shitamachi-que-puedes-visitar-hoy" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 03 · La vida en el shitamachi</span></div>
            <h2 id="section-03-la-vida-en-el-shitamachi" className="scroll-mt-20">
            ...
            {/* Cómo visitar */}
            <div className="section-eyebrow"><span>Section 04 · Cómo visitar el shitamachi sin romper su magia</span></div>
            <h2 id="section-04-cómo-visitar-el-shitamachi-sin-romper-su-magia" className="scroll-mt-20">
            ...
            {/* Mi ruta personal */}
            <div className="section-eyebrow"><span>Section 05 · Mi ruta personal por el shitamachi de Tokio</span></div>
            <h2 id="section-05-mi-ruta-personal-por-el-shitamachi-de-tokio" className="scroll-mt-20">
