  ...
  return (
    <Layout>
      ...
      <BlogArticleHero
        ...
        imageAlt="Tamagoyaki en el mercado de Tsukiji 2026"
      ...
      />
        ...
        <div className="container-section">
          ...
          { num: "01", label: "Mi mañana típica en Tsukiji", href: "#section-01-mi-mañana-típica-en-tsukiji" },
          { num: "02", label: "Los 7 bocados imprescindible…", href: "#section-02-los-7-bocados-imprescindibles-en-2026" },
          { num: "03", label: "Lo nuevo en Tsukiji este año", href: "#section-03-lo-nuevo-en-tsukiji-este-año" },
          { num: "04", label: "Presupuesto real", href: "#section-04-presupuesto-real" },
          { num: "05", label: "FAQ", href: "#section-05-faq" }
            ...
            <div className="section-eyebrow"><span>Section 01 · Mi mañana típica en Tsukiji</span></div>
            <h2 id="section-01-mi-mañana-típica-en-tsukiji" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 02 · Los 7 bocados imprescindibles en 2026</span></div>
            <h2 id="section-02-los-7-bocados-imprescindibles-en-2026" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 03 · Lo nuevo en Tsukiji este año</span></div>
            <h2 id="section-03-lo-nuevo-en-tsukiji-este-año" className="scroll-mt-20">
              Lo nuevo en Tsukiji este año
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            {/* Presupuesto real */}
            <div className="section-eyebrow"><span>Section 04 · Presupuesto real</span></div>
            <h2 id="section-04-presupuesto-real" className="scroll-mt-20">
