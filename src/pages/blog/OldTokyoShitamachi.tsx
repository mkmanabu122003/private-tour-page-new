            ...
            <div className="mt-16">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    A half day (3–4 hours) covers one neighborhood well — Asakusa or Yanaka. A full day lets you combine two neighborhoods with lunch in between. If you're genuinely interested in old Tokyo, dedicate at least two half-days to Shitamachi areas during your trip.
                  </p>
                </div>
                <div>
