  ...
  return (
    <Layout>
      ...
      <BlogArticleHero
        ...
        imageAlt="Kaminarimon Gate in Asakusa, understanding tipping culture in Japan"
        eyebrow="Cultural Tips"
        title="Tipping in Japan: What You Need to Know (From a Local Guide)"
      ...
      />
        ...
        <div className="container-section">
          ...
          { num: "01", label: "The Moment a Guest Tried to…", href: "#section-01-the-moment-a-guest-tried-to-tip-me" },
          { num: "02", label: "Why Tipping Bewilders Most…", href: "#section-02-why-tipping-bewilders-most-japanese-people" },
          { num: "03", label: "Does the \"No Tipping\" Rule…", href: "#section-03-does-the-no-tipping-rule-apply-everywhere" },
          { num: "04", label: "How to Show Appreciation…", href: "#section-04-how-to-show-appreciation-the-japanese-way" },
          { num: "05", label: "What About Tour Guides?", href: "#section-05-what-about-tour-guides" },
          { num: "06", label: "FAQ", href: "#section-06-faq" }
            ...
            <div className="section-eyebrow"><span>Section 01 · The Moment a Guest Tried to Tip Me</span></div>
            <h2 id="section-01-the-moment-a-guest-tried-to-tip-me" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 02 · Why Tipping Bewilders Most Japanese People</span></div>
            <h2 id="section-02-why-tipping-bewilders-most-japanese-people" className="scroll-mt-20">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Think of it this way: imagine you finish a project at work, and a colleague hands you a 
            <QuickAnswer
              answer="The average tip in Japan is ¥0. Tipping is not customary and can cause confusion — most Japanese workers will try to return the money. This applies to restaurants, taxis, hotels, and shops."
              hook="But there are 3 specific situations where showing gratitude IS expected — and getting it wrong can be awkward. A local guide explains the full etiquette below."
            />
            ...
            <div className="section-eyebrow"><span>Section 03 · Does the "No Tipping" Rule Apply Everywhere?</span></div>
            <h2 id="section-03-does-the-no-tipping-rule-apply-everywhere" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 04 · How to Show Appreciation the Japanese Way</span></div>
            <h2 id="section-04-how-to-show-appreciation-the-japanese-way" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 05 · What About Tour Guides?</span></div>
            <h2 id="section-05-what-about-tour-guides" className="scroll-mt-20">
          ...
          0 bill and says "nice work." You'd probably find it awkward, not because you're angry, but because it's just not how things work in your environment. That's roughly how tipping feels to many Japanese service workers. It's unexpected and confusing, not something they know how to respond to.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              There's also a practical dimension. Japanese workers are paid a fair wage for their service. Unlike the American system, where tips can constitute 50–70% of a server's income, Japanese service workers receive their full compensation through their employer. Since tipping has never been part of the system, receiving one can feel like an unexpected situation that nobody trained them to handle.
            </p>
