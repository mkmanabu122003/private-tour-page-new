      ...
      />
        ...
        <div className="container-section">
          ...
          { num: "06", label: "FAQ", href: "#section-06-faq" }
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Since we are on the subject of money, I have also written up{" "}
              <Link to="/blog/tokyo-private-tour-guide-cost" className="text-accent hover:underline">
                what a private tour guide in Tokyo actually costs
              </Link>{" "}
              — the real numbers, what drives them up or down, and how to tell whether a quote is fair.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
