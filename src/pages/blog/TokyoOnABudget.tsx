  ...
  return (
    <Layout>
      ...
      <BlogArticleHero
        ...
        imageAlt="Nakamise shopping street in Asakusa, Tokyo on a budget"
        eyebrow="Planning Your Trip"
        title="Tokyo on a Budget: What a Local Guide Spends (And How)"
        subtitle="Written by Manabu, a licensed guide who lives in Tokyo year-round and knows exactly what things cost, because he pays for them every day."
        date="March 7, 2026"
        backHref="/blog"
      ...
      />
        ...
        <div className="container-section">
          ...
          { num: "01", label: "The Tokyo Budget Myth", href: "#section-01-the-tokyo-budget-myth" },
          { num: "02", label: "Daily Costs", href: "#section-02-daily-costs" },
          { num: "03", label: "Where to Eat for Under ¥1,000", href: "#section-03-where-to-eat-for-under-1000" },
          { num: "04", label: "Free Things Worth Doing in…", href: "#section-04-free-things-worth-doing-in-tokyo" },
          { num: "05", label: "Where NOT to Cut Corners", href: "#section-05-where-not-to-cut-corners" },
          { num: "06", label: "FAQ", href: "#section-06-faq" }
            ...
            <div className="section-eyebrow"><span>Section 01 · The Tokyo Budget Myth</span></div>
            <h2 id="section-01-the-tokyo-budget-myth" className="scroll-mt-20">
              The Tokyo Budget Myth (It's Not as Expensive as You Think)
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Let me start with numbers, because numbers don't lie. A bowl of excellent ramen in Tokyo: ¥900–1,200 (roughly $6–8 USD). A comparable bowl of ramen in New York? 8–22 before tip. A single-ride subway ticket in Tokyo: ¥170–200. In London, the Tube costs £2.80 minimum. A convenience store lunch in Tokyo that's genuinely good (onigiri, a side, and green tea): ¥500. Try getting lunch in Paris for under five euros.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div className="section-eyebrow"><span>Section 02 · Daily Costs</span></div>
            <h2 id="section-02-daily-costs" className="scroll-mt-20">
            ...
            <h3>Transport: ¥1,000–1,500 per day</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <h3>Food: ¥3,000–8,000 per day</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
              This is the widest range, and it depends entirely on your choices. The floor is remarkably low. You can eat three satisfying meals in Tokyo for ¥3,000 (about 
            <p className="text-lg text-muted-foreground leading-relaxed mb-4">
              "Tokyo must be so expensive." I hear this from nearly every client before they arrive. They've read the articles, seen the price tags on Wagyu beef, maybe checked hotel rates in Ginza. And I understand the concern. Tokyo on a budget sounds like a contradiction. But here's the thing: I live here. I eat here every day. I take trains, visit temples, buy coffee. And my daily spending is probably lower than what you'd spend in Manhattan, London, or Sydney.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8">
            ...
            <h3>Attractions & Entry Fees: ¥500–2,000 per day</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div className="section-eyebrow"><span>Section 03 · Where to Eat for Under ¥1,000</span></div>
            <h2 id="section-03-where-to-eat-for-under-1000" className="scroll-mt-20">
            ...
            <h3>Convenience Stores (Seriously Good)</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div className="section-eyebrow"><span>Section 04 · Free Things Worth Doing in Tokyo</span></div>
            <h2 id="section-04-free-things-worth-doing-in-tokyo" className="scroll-mt-20">
            ...
            <div className="section-eyebrow"><span>Section 05 · Where NOT to Cut Corners</span></div>
            <h2 id="section-05-where-not-to-cut-corners" className="scroll-mt-20">
            ...
            <h3>Don't Skip One Good Sushi Meal</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <h3>Don't Take the Cheapest Accommodation in a Bad Location</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <div className="mt-16">
              ...
              <div className="faq-block space-y-8">
                <div>
                  <h3>How much money do I need per day in Tokyo?</h3>
                ...
                <div>
                  <h3>Is it cheaper to use a rail pass or buy individual tickets?</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3>Can I use credit cards everywhere in Tokyo?</h3>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3>What's the cheapest area to stay in Tokyo?</h3>
                  <p className="text-muted-foreground leading-relaxed">
          ...
          0 USD) without ever feeling like you're compromising. A convenience store breakfast (¥300–500), a gyudon lunch (¥500–700), and a ramen dinner (¥900–1,200) adds up to roughly ¥2,000–2,400, leaving room for snacks and a drink.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              At the higher end, ¥8,000 per day gets you a nice sit-down lunch, a mid-range sushi dinner, and all the matcha lattes and taiyaki street snacks you want in between. That's about $55 USD for a full day of eating well in one of the world's great food cities. Compare that to what you'd spend in New York eating at the same quality level.
            </p>
          ...
          5–40 for what might be the best sushi meal of your life. The fish is different. The rice is different. The experience of watching a craftsman work is different. This is the one splurge I recommend to every budget traveler, and nobody has ever regretted it.
            </p>
            <h3>Don't Take the Cheapest Accommodation in a Bad Location</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
              I've seen budget travelers book the cheapest hostel they can find, only to discover it's a 25-minute walk from the nearest station in a residential neighborhood with no restaurants or convenience stores nearby. They spend more on transport, waste time commuting, and miss out on the energy that makes Tokyo special. Location matters more than room size in Tokyo. A small, clean hotel or hostel near a major station (Shinjuku, Shibuya, Asakusa, Ueno) will save you money on transport, give you better food options within walking distance, and let you experience neighborhoods at night, which is when Tokyo truly comes alive.
