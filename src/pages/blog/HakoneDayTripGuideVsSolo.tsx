...
const HakoneDayTripGuideVsSolo = () => {
  return (
    <Layout>
        ...
        <div className="container-section">
          ...
          { num: "05", label: "When a Guide Changes…", href: "#section-05-when-a-guide-changes-everything" }
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Budget is the primary concern.</strong> The guide fee (¥80,000 for a full-day{" "}
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Groups of 3+</strong> where the ¥80,000 guide fee divided among the group makes it very reasonable per person
              </li>
            </ul>
      ...
      - Hakone day trip price (¥80,000): matches tour page
