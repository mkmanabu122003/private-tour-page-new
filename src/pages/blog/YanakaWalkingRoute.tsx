...
const YanakaWalkingRoute = () => {
  return (
    <Layout>
          ...
          <article className="max-w-3xl mx-auto prose-custom">
            ...
            <ul className="space-y-4 mb-8">
              <li className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Old wooden houses (machiya):</strong> Look for buildings with dark-stained wooden facades, sliding doors, and tiled roofs with slightly curved edges. These are traditional merchant houses, many dating to the early 1900s. The wood darkens naturally with age, so if a building is nearly black, it's genuinely old, not artificially stained.
              </li>
              <li className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Temple gates (sanmon):</strong> Each temple entrance tells you something about the temple's status and sect. A simple wooden gate with a tiled roof suggests a modest neighborhood temple. Larger gates with guardian figures (nio) indicate a temple of higher rank. Notice whether the gate's wood is painted or left natural, which often indicates the Buddhist sect.
              </li>
              <li className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Cat statues and real cats:</strong> Yanaka is famous for its cats, both living and sculpted. You'll find carved wooden cats on shop signs, ceramic cats in temple gardens, and actual cats lounging on walls and in doorways. The neighborhood has embraced its reputation, and there's even a cat-shaped donut shop. The real cats are community cats, fed and cared for by residents.
              </li>
              <li className="text-muted-foreground leading-relaxed">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Part of what makes this yanaka tokyo walking route so satisfying is the food. Yanaka Ginza is essentially an edible street where you can graze your way from one end to the other and call it lunch.
            </p>
            <ul className="space-y-4 mb-8">
              <li className="text-muted-foreground leading-relaxed">
              ...
              <li className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Yakitori and skewers:</strong> A few shops sell grilled chicken skewers and other items on sticks, all perfect walking food. Look for the places with the most smoke coming out of the front.
              </li>
              <li className="text-muted-foreground leading-relaxed">
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Summer considerations:</strong> July and August are hot and humid. If you visit in summer, start early, around 8:30 AM, and plan to finish before the midday heat. The shade from the cemetery trees and temple grounds helps, but Yanaka Ginza is fully exposed.
              </li>
              <li className="text-muted-foreground leading-relaxed">
      ...
      <RelatedTourCards tourIds={["yanaka"]} />
