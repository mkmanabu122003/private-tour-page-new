      ...
      <section className="py-16">
        <div className="container-section">
          <article className="max-w-3xl mx-auto prose-custom">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              The <strong className="text-foreground">Sumida River Fireworks Festival</strong> in late July is one of Japan's oldest and largest fireworks displays, with nearly 20,000 fireworks over the Sumida River near Asakusa. Neighborhood matsuri (festivals) happen every weekend from July through August, with portable shrines paraded through streets, taiko drumming, food stalls selling yakitori and kakigori (shaved ice), and people wearing colorful yukata (summer kimono). These aren't tourist events. They're community traditions that have continued for centuries, and participating in one is one of the most authentic cultural experiences you can have in Tokyo.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">December</strong> kicks off with illumination season, with massive light displays at Roppongi Hills, Marunouchi (near Tokyo Station), Omotesando, and Caretta Shiodome. Many are free. An evening walk through the illuminations followed by a hot bowl of ramen is one of Tokyo's most underrated experiences.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
