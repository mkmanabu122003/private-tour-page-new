        ...
        <div className="container-section">
          <article className="max-w-3xl mx-auto prose-custom">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              Asakusa is the neighborhood I know best in all of Tokyo. I lead tours here almost every day, and after hundreds of visits I still find new things to notice — the way morning light hits the incense smoke at Senso-ji, or a craft shop I somehow never spotted before. But I also see the same mistakes repeated by visitors every single day: arriving at noon, following the crowd down the main street, snapping a photo of the giant red lantern, and leaving within 45 minutes thinking they have "done" Asakusa. They haven't even scratched the surface.
            </p>
