      ...
      <section className="py-16">
        <div className="container-section">
          <article className="max-w-3xl mx-auto prose-custom">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Seasonal variations:</strong> Spring (late March to mid-April) brings cherry blossom viewers who combine Senso-ji with hanami along the Sumida River. Golden Week (late April to early May) is the busiest period after New Year's. Summer sees slightly fewer visitors due to Tokyo's brutal humidity, though the Sumida River Fireworks Festival in late July creates a massive one-day spike. Autumn is popular with domestic tourists enjoying fall foliage. And January 1-3 brings the Hatsumode rush, with an estimated 2.8 million people visit Senso-ji in just those three days.
            </p>
