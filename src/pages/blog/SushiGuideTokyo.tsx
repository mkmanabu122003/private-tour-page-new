      ...
      <section className="py-16">
        <div className="container-section">
          <article className="max-w-3xl mx-auto prose-custom">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              One more thing: eat each piece in one bite if possible. Nigiri is constructed as a single unit — the balance of fish, rice, and wasabi is designed for one mouthful. Biting it in half disrupts that balance and usually results in it falling apart. If the piece is too large (some chefs make them big), it's okay to ask the chef to make them smaller. A good chef will appreciate that you care.
            </p>
